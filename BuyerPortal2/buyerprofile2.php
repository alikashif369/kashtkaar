...
<br>
    ...
    <div class="container" >
        <div class="form">
            ...
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="fas fa-pencil-alt mr-2"></i>CNIC No.</span> <!-- Updated label -->
                </div>
                <input type="text" readonly class="form-control-plaintext border border-dark" id="staticEmail" value=" <?php echo $cnic ?> "> <!-- Updated variable -->
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
        ...
        <button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#292b2c;color:goldenrod" onclick="window.location.href='editprofile.php'">Edit Profile</button>
    </div>
